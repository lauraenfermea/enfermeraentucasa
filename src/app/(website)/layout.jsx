...
export default async function RootLayout({ children }) {
  ...
  try {
    ...
    settings = await fetchClient.fetch(`*[_type == "settings"][0]`);
  } catch (error) {
    console.error("Failed to fetch global settings, falling back to defaults:", error);
  }

  const whatsapp = settings?.whatsappLink || "https://wa.me/34641635705";
